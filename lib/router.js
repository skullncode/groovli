...
Router.route('/profile/:_id', {
  subscriptions: function() {
    ...
    Meteor.subscribe('allSongsForSpecificUser', this.params._id, {onError: onErrorWithSubscription});
    this.wait(Meteor.subscribe('userObjectForProfilePage', this.params._id, {onError: onErrorWithSubscription}));
    Meteor.subscribe('favoritesForSpecificUser', String(Router.current().params._id), {onError: onErrorWithSubscription});
  },
