...
Router.onBeforeAction(requireLogin, {only: ['songboard', 'editprofile', 'profile', 'invites', 'friendlist', 'messages']});
Router.onBeforeAction(mustBeAdmin, {only: ['invites', 'pending', 'existing', 'allusers', 'invalid']});
