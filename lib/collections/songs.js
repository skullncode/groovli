...
Meteor.methods({
	...
	getLast10TrendingSongsForLandingPage: function() {
      	var y = Songs.find({$or: [{iTunesValid:'VALID'},{LFMValid:'VALID'},{manualApproval:'VALID'}], $and: [{'cover': {'$ne': true}}, {'iTunesLargeAlbumArt': {'$ne': ''}}, {'iTunesLargeAlbumArt': {'$ne': 'none'}}, {'iTunesLargeAlbumArt': { $regex: /^http:/i }}]}, {sort: {'sharedBy.systemDate': -1}, limit:50,
      	fields: {
	...
	getLast20SongsForLandingPage: function() {
		...
		var x = Songs.find({$and: [{'cover': {'$ne': true}}, {'iTunesLargeAlbumArt': {'$ne': ''}}, {'iTunesLargeAlbumArt': {'$ne': 'none'}}, {'iTunesLargeAlbumArt': { $regex: /^http:/i }}, {'sl': {$in: randomSample}}]}, {sort: {'sharedBy.systemDate': -1}, limit:6, 
			fields: {
				"iTunesLargeAlbumArt": 1,
        		"sa": 1,
        		"st": 1,
