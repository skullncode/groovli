...
Meteor.methods({
	...
	getLast20SongsForLandingPage: function() {
		...
		var x = Songs.find({$and: [{'LFMLargeAlbumArt': {'$ne': ''}}, {'LFMLargeAlbumArt': {'$ne': 'none'}}, {'LFMLargeAlbumArt': { $regex: /^http:/i }}, {'sl': {$in: onlyLinksForListens}}]}, {sort: {'sharedBy.systemDate': -1}, limit:6, 
			fields: {
				"LFMLargeAlbumArt": 1,
        		"sa": 1,
        		"st": 1,
