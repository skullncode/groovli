...
Meteor.methods({
	...
	getLast20SongsForLandingPage: function() {
		...
		var x = Songs.find({$and: [{'cover': {'$ne': true}}, {'iTunesLargeAlbumArt': {'$ne': ''}}, {'iTunesLargeAlbumArt': {'$ne': 'none'}}, {'iTunesLargeAlbumArt': { $regex: /^http:/i }}, {'sl': {$in: randomSample}}]}, {sort: {'sharedBy.systemDate': -1}, limit:16, 
			fields: {
				"iTunesLargeAlbumArt": 1,
        		"sa": 1,
        		"st": 1,
